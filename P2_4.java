...
// Write a test program that createsobjects of Account, SavingsAccount, 
// and CheckingAccount and invokes their toString() methods
// GITHUB LINK : https://github.com/PatelVraj10/java-practical-file-1
public class P2_4 {
private int id=0;
double balance=500,annualInterest=7,amount; String dateCreated;
P2_4()	//Here we use constructor
{
id=0; balance=50000; annualInterest=7;
}
